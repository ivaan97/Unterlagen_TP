 ...
 * 
 */
@WebServiceClient(name = "TempConvert", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8080/converter.asmx?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEMPCONVERT_QNAME = new QName("http://tempuri.org/", "TempConvert");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/converter.asmx?wsdl");
