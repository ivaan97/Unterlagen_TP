 ...
 * generated in the webservice.gen.Service package. 
...
public class ObjectFactory {
    ...
    private final static QName _DoppeltResponseDoppeltResult_QNAME = new QName("http://tempuri.org/", "doppeltResult");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice.gen.Service
     * 
     */
    ...
    /**
     * Create an instance of {@link Doppelt }
     * 
     */
    public Doppelt createDoppelt() {
        return new Doppelt();
    }
    ...
    /**
     * Create an instance of {@link DoppeltResponse }
     * 
     */
    public DoppeltResponse createDoppeltResponse() {
        return new DoppeltResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "doppeltResult", scope = DoppeltResponse.class)
    public JAXBElement<String> createDoppeltResponseDoppeltResult(String value) {
        return new JAXBElement<String>(_DoppeltResponseDoppeltResult_QNAME, String.class, DoppeltResponse.class, value);
    }
